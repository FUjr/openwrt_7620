...
define Build/zlmnet-header
        $(STAGING_DIR_HOST)/bin/mkzlmnetfw  -i $@ -o $@.new
        mv $@.new  $@
endef
...
define Device/zlmnet-f8-16M
  DTS := ZLMNET-F8-16M
  IMAGE_SIZE := $(ralink_default_fw_size_16M)
  DEVICE_TITLE := ZLMNET ZLMNET-F8 (16M)
  IMAGES += factory.bin
  IMAGE/factory.bin := $$(sysupgrade_bin) | check-size $$$$(IMAGE_SIZE) | \
	zlmnet-header
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ohci kmod-mt76 kmod-sdhci-mt7620 
endef
TARGET_DEVICES += zlmnet-f8-16M

define Device/zlmnet-f8-32M
  DTS := ZLMNET-F8-32M
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  DEVICE_TITLE := ZLMNET ZLMNET-F8 (32M)
  IMAGES += factory.bin
  IMAGE/factory.bin := $$(sysupgrade_bin) | check-size $$$$(IMAGE_SIZE) | \
	zlmnet-header
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ohci kmod-mt76 kmod-sdhci-mt7620
endef
TARGET_DEVICES += zlmnet-f8-32M
